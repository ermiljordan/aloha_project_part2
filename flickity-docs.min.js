...
! function (t, n) {
    ...
    function o() {}
    var i = o.prototype = Object.create(n.prototype);
    i.bindStartEvent = function (t) {
        ...
        t.navigator.pointerEnabled ? n[o]("pointerdown", this) : t.navigator.msPointerEnabled ? n[o]("MSPointerDown", this) : (n[o]("mousedown", this), n[o]("touchstart", this))
    ...
    }, i.onMSPointerDown = i.onpointerdown = function (t) {
    ...
    return i._bindPostStartEvents = function (n) {
    ...
    }, i.onMSPointerMove = i.onpointermove = function (t) {
        ...
        this._pointerUp(t, t)
    }, i.onMSPointerUp = i.onpointerup = function (t) {
    ...
    }, i.pointerDone = e, i.onMSPointerCancel = i.onpointercancel = function (t) {
...
! function (t, n) {
    ...
    return o._bindHandles = function (t) {
        t = void 0 === t ? !0 : !!t;
        var n;
        n = r.pointerEnabled ? function (n) {
            n.style.touchAction = t ? "none" : ""
        } : r.msPointerEnabled ? function (n) {
            n.style.msTouchAction = t ? "none" : ""
        } : i;
        for (var e = t ? "addEventListener" : "removeEventListener", o = 0; o < this.handles.length; o++) {
            var s = this.handles[o];
            this._bindStartEvent(s, t), n(s), s[e]("click", this)
        }
        ...
        this.pointerDownPoint = n.getPointerPoint(i);
        var e = this.canPreventDefaultOnPointerDown(t, i);
        e && t.preventDefault()
    ...
    }, o._dragPointerUp = function (t, n) {
        this.isDragging ? this._dragEnd(t, n) : this._staticClick(t, n)
    }, o._dragStart = function (t, i) {
        this.isDragging = !0, this.dragStartPoint = n.getPointerPoint(i), this.isPreventingClicks = !0, this.dragStart(t, i)
    }, o.dragStart = function (t, n) {
        this.emitEvent("dragStart", [t, n])
    }, o._dragMove = function (t, n, i) {
        this.isDragging && this.dragMove(t, n, i)
    }, o.dragMove = function (t, n, i) {
        t.preventDefault(), this.emitEvent("dragMove", [t, n, i])
    }, o._dragEnd = function (t, n) {
        this.isDragging = !1, setTimeout(function () {
            delete this.isPreventingClicks
        }.bind(this)), this.dragEnd(t, n)
    }, o.dragEnd = function (t, n) {
        this.emitEvent("dragEnd", [t, n])
    }, o.onclick = function (t) {
        this.isPreventingClicks && t.preventDefault()
    }, o._staticClick = function (t, n) {
        if (!this.isIgnoringMouseUp || "mouseup" != t.type) {
            var i = t.target.nodeName;
            ("INPUT" == i || "TEXTAREA" == i) && t.target.focus(), this.staticClick(t, n), "mouseup" != t.type && (this.isIgnoringMouseUp = !0, setTimeout(function () {
                delete this.isIgnoringMouseUp
            }.bind(this), 400))
        }
    }, o.staticClick = function (t, n) {
        this.emitEvent("staticClick", [t, n])
    }, e.getPointerPoint = n.getPointerPoint, e
});
! function (t, e) {
    ...
    return i.bindTap = function (t) {
        ...
        if (!this.isIgnoringMouseUp || "mouseup" != n.type) {
            var o = e.getPointerPoint(i),
                p = this.tapElement.getBoundingClientRect(),
                s = t.pageXOffset,
                u = t.pageYOffset,
                r = o.x >= p.left + s && o.x <= p.right + s && o.y >= p.top + u && o.y <= p.bottom + u;
            if (r && this.emitEvent("tap", [n, i]), "mouseup" != n.type) {
                this.isIgnoringMouseUp = !0;
                var f = this;
                setTimeout(function () {
                    delete f.isIgnoringMouseUp
                }, 400)
            }
        }
    }, i.destroy = function () {
...
! function (t, i) {
    ...
    "use strict";
    var e = t.requestAnimationFrame || t.webkitRequestAnimationFrame,
        s = 0;
    e || (e = function (t) {
    ...
    return n.positionSlider = function () {
        var t = this.x;
        this.options.wrapAround && this.cells.length > 1 && (t = i.modulo(t, this.slideableWidth), t -= this.slideableWidth, this.shiftWrapCells(t)), t += this.cursorPosition, t = this.options.rightToLeft && o ? -t : t;
        var e = this.getPositionValue(t);
        this.slider.style[o] = this.isAnimating ? "translate3d(" + e + ",0,0)" : "translateX(" + e + ")";
        var s = this.slides[0];
        if (s) {
            var n = -this.x - s.target,
                r = n / this.slidesWidth;
            this.dispatchEvent("scroll", null, [r, n])
        }
...
! function (e, t) {
    ...
    s.extend(g, t.prototype), g._create = function () {
        ...
        for (var s = this.cells.length, l = e; s > l; l++) {
            var n = this.cells[l];
    ...
    return g.setCellAlign = function () {
        ...
        this.isActive && (e = parseInt(e, 10), this._wrapSelect(e), (this.options.wrapAround || t) && (e = s.modulo(e, this.slides.length)), this.slides[e] && (this.selectedIndex = e, this.updateSelectedSlide(), i ? this.positionSliderAtSelected() : this.startAnimation(), this.options.adaptiveHeight && this.setGallerySize(), this.dispatchEvent("select"), this.dispatchEvent("cellSelect")))
        ...
        !this.isDragSelect && n > h ? e += t : !this.isDragSelect && n > r && (e -= t), 0 > e ? this.x -= this.slideableWidth : e >= t && (this.x += this.slideableWidth)
        ...
        var s;
        "number" == typeof e ? s = this.cells[e] : ("string" == typeof e && (e = this.element.querySelector(e)), s = this.getCell(e));
        for (var l = 0; s && l < this.slides.length; l++) {
            var n = this.slides[l],
                h = n.cells.indexOf(s);
            if (-1 != h) return void this.select(l, t, i)
        }
    ...
    }, s.debounceMethod(o, "onresize", 150), g.resize = function () {
        if (this.isActive) {
        ...
        if (e) {
            var t = a(this.element, ":after").content; - 1 != t.indexOf("flickity") ? this.activate() : this.deactivate()
        }
        ...
        this.deactivate(), e.removeEventListener("resize", this), this.emitEvent("destroy"), c && this.$element && c.removeData(this.element, "flickity"), delete this.element.flickityGUID, delete u[this.guid]
    }, s.extend(g, h), o.data = function (e) {
        e = s.getQueryElement(e);
        var t = e && e.flickityGUID;
        return t && u[t]
    }, s.htmlInit(o, "flickity"), c && c.bridget && c.bridget("flickity", o), o.Cell = l, o
});
! function (t, i) {
    ...
    var r = i.prototype;
    s.extend(r, e.prototype), r._createDrag = function () {
    ...
    r.pointerDown = function (i, e) {
        var s = o[i.target.nodeName] && !a[i.target.type];
        if (s) return this.isPointerDown = !1, void delete this.pointerIdentifier;
        this._dragPointerDown(i, e);
        var r = document.activeElement;
        r && r.blur && r != this.element && r != document.body && r.blur(), this.pointerDownFocus(i), this.dragX = this.x, this.viewport.classList.add("is-pointer-down"), this._bindPostStartEvents(i), this.pointerDownScroll = n(), t.addEventListener("scroll", this), this.dispatchEvent("pointerDown", i, [e])
    };
    var h = {
            touchstart: !0,
            MSPointerDown: !0
    ...
    return r.pointerDownFocus = function (i) {
        if (this.options.accessibility && !h[i.type] && !d[i.target.nodeName]) {
            var e = t.pageYOffset;
    ...
    }, r.dragMove = function (t, i, e) {
        t.preventDefault(), this.previousDragX = this.dragX;
        var s = this.options.rightToLeft ? -1 : 1,
            n = this.dragStartPosition + e.x * s;
        ...
        return n
    }, r._getClosestResting = function (t, i, e) {
        for (var s = this.selectedIndex, n = 1 / 0, r = this.options.contain && !this.options.wrapAround ? function (t, i) {
                return i >= t
            } : function (t, i) {
                return i > t
            }; r(i, n) && (s += e, n = i, i = this.getSlideDistance(-t, s), null !== i);) i = Math.abs(i);
        return {
            distance: n,
            index: s - e
        }
    }, r.getSlideDistance = function (t, i) {
...
! function (t, e) {
    ...
    o.prototype = new s, o.prototype._create = function () {
        ...
        for (var e = document.createDocumentFragment(), s = []; t;) {
            var i = document.createElement("li");
            i.className = "dot", e.appendChild(i), s.push(i), t--
        }
    ...
    return s.insert = function (e, t) {
        ...
        if (i && i.length) {
            ...
            if (0 === t) this.cells = i.concat(this.cells);
                ...
                var d = this.cells.splice(t, s - t);
                this.cells = this.cells.concat(i).concat(d)
            }
            this._sizeCells(i);
            var o = t > this.selectedIndex ? 0 : i.length;
            this._cellAddedRemoved(t, o)
        }
    }, s.append = function (e) {
        ...
        var t, l, s = this.getCells(e),
            n = 0,
            h = s.length;
        for (t = 0; h > t; t++) {
            l = s[t];
            var c = this.cells.indexOf(l) < this.selectedIndex;
            n -= c ? 1 : 0
        }
        for (t = 0; h > t; t++) l = s[t], l.remove(), i.removeFrom(this.cells, l);
        s.length && this._cellAddedRemoved(0, n)
    }, s._cellAddedRemoved = function (e, t) {
        ...
        if (this._positionCells(e), this._getWrapShiftCells(), this.setGallerySize(), this.emitEvent("cellChange", [e]), this.options.freeScroll) {
            var l = i - this.slideableWidth;
            this.x += l * this.cellAlign, this.positionSlider()
        } else t && this.positionSliderAtSelected(), this.select(this.selectedIndex)
    }, t
});
! function (t, i) {
    "function" == typeof define && define.amd ? define(["./flickity", "fizzy-ui-utils/utils"], function (e, o) {
        return i(t, e, o)
    ...
    return n._createLazyload = function () {
        ...
        var e = this.flickity.getParentCell(this.img),
            o = e && e.element;
        this.flickity.cellSizeChange(o), this.img.classList.add(i), this.flickity.dispatchEvent("lazyLoad", t, o)
    }, i.LazyLoader = a, i
});
! function (t, e) {
    "use strict";
...
! function (t, i) {
    ...
    function r(t, i) {
        this.element = "string" == typeof t ? h.querySelector(t) : t, u && (this.$element = u(this.element)), this.options = s({}, this.constructor.defaults), this.option(i), this._create()
    }
    ...
    var g = h.documentElement,
        p = "string" == typeof g.style.transform ? "transform" : "WebkitTransform",
        u = t.jQuery,
        c = r.prototype = Object.create(e.prototype);
    r.defaults = {}, c.option = function (t) {
        s(this.options, t)
    };
    var f = {
        relative: !0,
    ...
    return c._create = function () {
        ...
        f[t.position] || (this.element.style.position = "relative"), this.enable(), this.setHandles()
    }, c.setHandles = function () {
        this.handles = this.options.handle ? this.element.querySelectorAll(this.options.handle) : [this.element], this.bindHandles()
    }, c.dispatchEvent = function (i, e, n) {
        var s = [e].concat(n);
        this.emitEvent(i, s);
        var o = t.jQuery;
        if (o && this.$element)
            if (e) {
                var r = o.Event(e);
                r.type = i, this.$element.trigger(r, n)
    ...
    }, c._getPositionCoord = function (t, e) {
        if (-1 != t.indexOf("%")) {
            var n = i(this.element.parentNode);
            return n ? parseFloat(t) / 100 * n[e] : 0
        }
        return parseInt(t, 10)
    }, c._addTransformPosition = function (t) {
        var i = t[p];
    ...
    }, c.pointerMove = function (t, i) {
        var e = this._dragPointerMove(t, i);
        this.dispatchEvent("pointerMove", t, [i, e]), this._dragMove(t, i, e)
    }, c.dragStart = function (t, i) {
    ...
    }, c.measureContainment = function () {
        var t = this.options.containment;
        if (t) {
            var e = o(t) ? t : "string" == typeof t ? h.querySelector(t) : this.element.parentNode,
                n = i(this.element),
                s = i(e),
                r = this.element.getBoundingClientRect(),
                a = e.getBoundingClientRect(),
                d = s.borderLeftWidth + s.borderRightWidth,
                l = s.borderTopWidth + s.borderBottomWidth,
                g = this.relativeStartPosition = {
                    x: r.left - (a.left + s.borderLeftWidth),
                    y: r.top - (a.top + s.borderTopWidth)
                };
            this.containSize = {
                width: s.width - d - g.x - n.width,
                height: s.height - l - g.y - n.height
            }
        }
    }, c.dragMove = function (t, i, e) {
        if (this.isEnabled) {
            var n = e.x,
                s = e.y,
                o = this.options.grid,
                r = o && o[0],
                h = o && o[1];
            n = a(n, r), s = a(s, h), n = this.containDrag("x", n, r), s = this.containDrag("y", s, h), n = "y" == this.options.axis ? 0 : n, s = "x" == this.options.axis ? 0 : s, this.position.x = this.startPosition.x + n, this.position.y = this.startPosition.y + s, this.dragPoint.x = n, this.dragPoint.y = s, this.dispatchEvent("dragMove", t, [i, e])
        }
    }, c.containDrag = function (t, i, e) {
        if (!this.options.containment) return i;
        var n = "x" == t ? "width" : "height",
            s = this.relativeStartPosition[t],
            o = a(-s, e, "ceil"),
            r = this.containSize[n];
        return r = a(r, e, "floor"), Math.min(r, Math.max(o, i))
    }, c.pointerUp = function (t, i) {
        this.element.classList.remove("is-pointer-down"), this.dispatchEvent("pointerUp", t, [i]), this._dragPointerUp(t, i)
    }, c.dragEnd = function (t, i) {
    ...
    }, c._init = n, u && u.bridget && u.bridget("draggabilly", r), r
});
! function () {
    "use strict";
    var e = window.FlickityDocs = {};
    e.modules = {}, window.utils = fizzyUIUtils, e.makeCellElem = function (e) {
        var t = document.createElement("div");
        t.className = "carousel-cell";
        var n = document.createElement("span");
        return n.className = "carousel-cell__number", n.textContent = e, t.appendChild(n), t
    }, window.filterBind = function (e, t, n, l) {
        e.addEventListener(t, function (e) {
            matchesSelector(e.target, n) && l(e)
        })
    }
}();
FlickityDocs.modules["commercial-license-agreement"] = function (e) {
    ...
    function t(e) {
        var t = r.querySelector(".is-selected");
        t && t.classList.remove("is-selected"), e.classList.add("is-selected");
        for (var i = e.getAttribute("data-license-option"), n = o[i], a = 0, c = l.length; c > a; a++) {
            var s = l[a];
            s.element.textContent = n[s.property]
        }
    }
    var o = {
            developer: {
        ...
        n = i.cloneNode(!0);
    n.style.borderTop = "none", n.style.marginTop = 0, n.id = "", i.textContent = "", r.parentNode.insertBefore(n, r.nextSibling);
    for (var l = [], a = e.querySelectorAll("[data-license-property]"), c = 0, s = a.length; s > c; c++) {
        var p = a[c],
            u = {
    ...
    t(r.querySelector(".button--developer")), filterBind(r, "click", ".button", function (e) {
        t(e.target)
    })
};
FlickityDocs.modules["fizzy-bear-shirt"] = function (e) {
    "use strict";
...
FlickityDocs.modules["hero-carousel"] = function (e) {
    "use strict";
    ...
    if (c) {
        ...
        o.onload = function () {
            c.src = o.src
        }, o.src = "img/flickity-illustration.gif"
    }
};
FlickityDocs.modules["page-nav"] = function (c) {
    "use strict";
    new Stickeroo(c)
};
! function (t) {
...
FlickityDocs.modules.append = function (e) {
    "use strict";
    var l = e.querySelector(".carousel"),
        t = new Flickity(l, {
            initialIndex: 2
        }),
        c = t.cells.length + 1,
...
FlickityDocs.modules["arrow-wiz"] = function (e) {
    ...
    function t(e, t, o, n, r) {
        r && (s.strokeStyle = r), s.beginPath(), s.moveTo(e, t), s.lineTo(o, n), s.stroke(), s.closePath()
    }
    ...
    function o() {
        ...
        for (e = 0; 11 > e; e++) {
            var n = 20 * e + .5;
            o = e % 5 ? v : d, t(0, n, f, n, o)
        }
        for (e = 0; 11 > e; e++) {
            var r = 20 * e + .5;
            o = e % 5 ? v : d, t(r, 0, r, h, o)
        }
    ...
    o();
    for (var w = [], S = [], T = 0; 4 > T; T++) {
        var g = x.querySelector(".arrow-wiz-illo__point--" + T),
            p = new Draggabilly(g, {
                containment: !0,
                grid: [10, 10]
            }),
            k = n(p, T);
        p.on("dragMove", k), S.push(p), w[T] = r(p)
    }
    var m = x.querySelector(".arrow-wiz-code code"),
        q = new Flickity(x.querySelector(".carousel"), {
            initialIndex: 2
        }),
...
FlickityDocs.modules["custom-nav"] = function (e) {
    ...
    var s = e.querySelector(".button--previous");
    s.addEventListener("click", function () {
        c.previous()
    });
    var i = e.querySelector(".button--next");
...
FlickityDocs.modules["events-table"] = function (e) {
    "use strict";
    ...
    function t(e, t) {
        ...
        l.className = "event-table__time", c.className = "event-table__event", a.className = "event-table__message";
        var o = new Date,
            d = o.getHours() + ":" + o.getMinutes() + ":" + o.getSeconds() + "." + o.getMilliseconds();
        l.textContent = d, c.textContent = e, a.textContent = t || "", n.appendChild(l), n.appendChild(c), n.appendChild(a);
        var i = r.children;
        1 == i.length ? r.appendChild(n) : r.insertBefore(n, i[1]);
        var s = r.children[11];
        s && r.removeChild(s)
    }
    ...
    var l = e.querySelector(".carousel"),
        c = new Flickity(l),
        a = e.querySelector(".event-table"),
        r = a.querySelector("tbody");
    c.on("select", function () {
        t("select", "selected cell " + (c.selectedIndex + 1))
    }), c.on("settle", function () {
        t("settle", "settled at cell " + (c.selectedIndex + 1))
    }), c.on("staticClick", function (e) {
        var n = "";
        if (matchesSelector(e.target, ".carousel-cell")) {
            var l = c.getCell(e.target),
                a = c.cells.indexOf(l) + 1;
            n = "clicked cell " + a
        }
        t("staticClick", n)
    });
    for (var o = ["dragStart", "dragMove", "dragEnd", "pointerDown", "pointerMove", "pointerUp"], d = 0, i = o.length; i > d; d++) {
        var s = o[d],
            u = n(s);
        c.on(s, u)
    }
...
FlickityDocs.modules.keyhole = function (e) {
    "use strict";
...
FlickityDocs.modules.parallax = function (l) {
    "use strict";

    function e(l, e, r) {
        l.style.left = 100 * (.5 - (.5 + 4 * r) * o * e) + "%"
    }
...
FlickityDocs.modules.player = function (e) {
    "use strict";

    function t() {
        r.textContent = u.player.state
    }
...
FlickityDocs.modules["progress-bar"] = function (r) {
    "use strict";
    var e = r.querySelector(".carousel"),
        o = r.querySelector(".progress-bar__bar"),
        t = new Flickity(e);
    t.on("scroll", function (r) {
        r = Math.max(0, Math.min(1, r)), o.style.width = 100 * r + "%"
    }), t.reposition()
};
FlickityDocs.modules.remove = function (e) {
    "use strict";
    var i = e.querySelector(".carousel"),
        c = new Flickity(i, {
            initialIndex: 1
        });
    c.on("staticClick", function (e, i, t) {
        t && c.remove(t)
    })
};
FlickityDocs.modules.reposition = function (i) {
    ...
    var t = i.querySelector(".carousel"),
        e = new Flickity(t);
    e.on("staticClick", function (i, t, o) {
        o && (o.classList.toggle("is-expanded"), e.reposition())
    })
};
...
FlickityDocs.modules.select = function (e) {
    ...
    var t = window.fizzyUIUtils,
        r = new Flickity(e.querySelector(".carousel")),
        c = e.querySelector(".button-group"),
        i = t.makeArray(c.querySelectorAll(".button"));
    filterBind(c, "click", ".button", function (e) {
        var t = i.indexOf(e.target);
        r.select(t)
    })
};
FlickityDocs.modules["select-cell"] = function (e) {
    "use strict";
    var t = window.fizzyUIUtils,
...
FlickityDocs.modules["select-cell-selector"] = function (e) {
    "use strict";
...
FlickityDocs.modules["select-instant"] = function (t) {
    "use strict";
...
FlickityDocs.modules["static-click"] = function (c) {
    "use strict";
    var e = c.querySelector(".carousel"),
        i = new Flickity(e, {
            initialIndex: 1
        }),
        t = c.querySelector(".logger");
    i.on("staticClick", function (c, i, l, s) {
        if (l) {
            var o = e.querySelector(".is-clicked");
            o && o.classList.remove("is-clicked"), l.classList.add("is-clicked"), t.textContent = "Cell " + (s + 1) + " clicked"
        }
    })
};
! function () {
    "use strict";
    for (var t = document.querySelectorAll("[data-js-module]"), e = 0, l = t.length; l > e; e++) {
        var o = t[e],
            u = o.getAttribute("data-js-module"),
            r = FlickityDocs.modules[u];
        r && r(o)
    }
}();